...
var CalificacionVendedor = /** @class */ (function (_super) {
    ...
    function CalificacionVendedor(fecha, id, calificacion, vendedor, comprador) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        CalificacionVendedor.crearConexion().query("SELECT * from calificaciones_vendedores where id=" + id, function (error, results) {
                            if (error)
                                resolve(error);
                            if (results.length != 0) {
                                var calificacion = new CalificacionVendedor(results[0].fecha, results[0].id, results[0].calificacion, results[0].id_vendedor, results[0].id_comprador);

...
var Calificacion_1 = require("./Calificacion");
var CalificacionComprador = /** @class */ (function (_super) {
    __extends(CalificacionComprador, _super);
    function CalificacionComprador(fecha, id, calificacion, vendedor, comprador) {
        return _super.call(this, fecha, id, calificacion, vendedor, comprador) || this;
    }
    CalificacionComprador.find = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        CalificacionComprador.crearConexion().query("SELECT * from calificaciones_compradores where id=" + id, function (error, results) {
                            if (error)
                                resolve(error);
                            if (results.length != 0) {
                                var calificacion = new CalificacionComprador(results[0].fecha, results[0].id, results[0].calificacion, results[0].id_vendedor, results[0].id_comprador);
    ...
    CalificacionComprador.prototype.save = function () {
        return __awaiter(this, void 0, void 0, function () {
            var fecha, idVendedor, idComprador, calificacion;
            return __generator(this, function (_a) {
                fecha = this.getFecha();
                idVendedor = this.getVendedor().getId();
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        CalificacionComprador.crearConexion().query("Insert into calificaciones_compradores values(null, " + idComprador + ", " + idVendedor + ", " + calificacion + ",\"" + fecha + "\")", function (error, results) {
                            if (error)
                                ...
                                resolve('Calificacion realizada');
                        });
                    })];
            });
        });

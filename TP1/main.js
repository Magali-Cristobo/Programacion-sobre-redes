...
if (mi_usuario.verb(una_peli, 140))
    console.log("Pepe no debería poder verb esa pelicula");
if (!otro_usuario.verb(una_peli, 100))
    console.log("Juan debería poder verb esa pelicula");
if (!otro_usuario.viendo(una_peli))
    console.log("Juan todavía está viendo la peli");
if (!otro_usuario.verb(una_peli, 40))
...
if (!mi_usuario.verb(una_serie, 20))
    console.log("Pepe debería poder verb esa serie");
if (mi_usuario.capituloActual(una_serie) != 0)
    console.log("Pepe está en el capitulo 0");
if (!mi_usuario.verb(una_serie, 40))
    console.log("Pepe debería poder verb esa serie");
...
if (!mi_usuario.verb(una_serie, 5))
    console.log("Pepe debería poder verb esa serie");
if (mi_usuario.viendo(una_serie))
    console.log("Pepe ya dejó de verb la serie");
if (!mi_usuario.visto(una_serie))
